...
danych w pamięci z odpytywaniem na poziomie API, eksperymentalnym
porządkowaniem, wieloma narzędziami. Jest mały i ma minimalne
zależności. Może sprawdzać izomorficzność grafów, działanie reguł itp.
